            ...
            >
              <v-card-text class="d-flex flex-column fdsfs">
                ...
                <div class="white--text d-flex mt-5">
                  <h3 style="font-size: 20px;">Ru:</h3><h3 class="ml-3">{{item.name.en}}</h3>
                </div>
                <div class="white--text d-flex mt-5">
                  <h3 style="font-size: 20px;">Eng:</h3><h3 class="ml-3">{{item.name.ru}}</h3>
                </div>
                <div class="white--text d-flex mt-5">
                  <h3 style="font-size: 20px;">space:</h3><h3 class="ml-3">{{item.space}}</h3>
                </div>
                <div class="white--text d-flex mt-5">
                  <h3 style="font-size: 20px;">price:</h3><h3 class="ml-3">{{item.price}}</h3>
                </div>
                <div class="white--text d-flex mt-5">
                  <h3 style="font-size: 20px;">rooms:</h3><h3 class="ml-3">{{item.rooms}}</h3>
                </div>
                <div class="white--text d-flex mt-5">
                  <h3 style="font-size: 20px;">floor:</h3><h3 class="ml-3">{{item.floor}}</h3>
                </div>
                </div>
                <v-row class="v-row">
                  <v-col cols="2"><v-btn
